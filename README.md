<div align="center">
  <img src="assets/vqgan-banner.svg" alt="Awesome-VQGAN Banner" width="100%"/>
</div>

<p align="center">
  <strong>A curated, comprehensive knowledge base on Vector Quantized Generative Adversarial Networks — tracking the evolution, architectural variants, training dynamics, production challenges, and frontier applications of VQGAN systems.</strong>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/github/stars/ishandutta2007/Awesome-VQGAN?style=social&label=Stars" alt="Stars"/>
  <img src="https://img.shields.io/github/forks/ishandutta2007/Awesome-VQGAN?style=social&label=Forks" alt="Forks"/>
  <img src="https://img.shields.io/github/watchers/ishandutta2007/Awesome-VQGAN?style=social&label=Watchers" alt="Watchers"/>
  <a href="https://github.com/ishandutta2007"><img alt="GitHub followers" src="https://img.shields.io/github/followers/ishandutta2007?label=Follow" /></a>
</p>

<p align="center">
  <a href="#-the-chronological-evolution">📅 Evolution</a> •
  <a href="#-core-functional--architectural-variants">🏗️ Variants</a> •
  <a href="#-training-dynamics--codebook-management">⚙️ Training</a> •
  <a href="#-production-engineering-challenges--adaptations">🚀 Production</a> •
  <a href="#-frontier-real-world-ai-applications">🌍 Applications</a>
</p>
...
> **Vector Quantized Generative Adversarial Network (VQGAN)** is a foundational deep learning architecture that merges the structural properties of Vector Quantized Variational Autoencoders (VQ-VAE) with the perceptual fidelity of Generative Adversarial Networks (GANs).
...
> 💡 **Why VQGAN matters:** It became the default visual codebook generator for the first generation of large-scale text-to-image systems, paving the way for modern multimodal AI.
...
## ⚙️ 3. Training Dynamics & Codebook Management
...
- [Discrete Foundation Era (VQ-VAE)](docs/discrete_foundation_era.md) — Deep dive into the origins of discrete visual tokenization
- [Adversarial Perceptual Revolution (VQGAN)](docs/adversarial_perceptual_revolution.md) — The breakthrough that enabled photorealistic generation
- [VQGAN: Taming Transformers (Original Paper)](https://arxiv.org/abs/2012.09841) — The seminal research paper
- [Awesome-Awesome-Awesome](https://github.com/ishandutta2007/Awesome-Awesome-Awesome) — The master awesome list

---

## 🤝 Contributing

Contributions are welcome! Feel free to open issues, submit pull requests, or suggest new papers and resources to add to this curated knowledge base.
